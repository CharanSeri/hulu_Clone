...
function Nav({ setSelectedOption }) {
    return (
        <div className="nav">
            ...
            <h4 onClick={() => setSelectedOption(requests.fetchMystery)}>
                Mystery
            </h4>
            <h4 onClick={() => setSelectedOption(requests.fetchSciFi)}>
                Sci-fi
                </h4>
            <h4 onClick={() => setSelectedOption(requests.fetchWestern)}>
                Western
            </h4>
            <h4 onClick={() => setSelectedOption(requests.fetchAnimation)}>
                Animation
            </h4>
            <h4 onClick={() => setSelectedOption(requests.fetchTV)}>
                Movie
                </h4>
        </div>
    )
